...
class timeFrame:
	def __init__(self):
		...
		self.enterMaps = {'submit': 'self.submitRequest()',
			...
			'startH': 'self._addDateTime()',
			'startM': 'self._addDateTime()',
			'endH': 'self._addDateTime()',
			'endM': 'self._addDateTime()',
			'startDateM': 'self._addDateTime()',
			'startDateD': 'self._addDateTime()',
			'startDateY': 'self._addDateTime()',
			'length': 'self._addDateTime()',
			'inputUser': 'getInput(self)'
		}
	...
	# 	"""
	# 	Removes a previously added user from the selected array.
	# 	"""
	...
	# 	"""
	# 	Removes a previously added time from the array.
	# 	"""
...
class availableUsers:
	...
	def buildWindows(self):
		#self.gui.addUIElement('list', '')
		# list of department managers available at each time slot, taking in multiple time slots
		# needs: take in multiple dates/times, list of users, return a list of department managers available during the time slot
		# need Date of meeting, start time and length
		# need method of adding users
		y = 4
		x = 60
